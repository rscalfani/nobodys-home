...
NAN_MODULE_INIT(OZW::Init) {
	...
	Nan::SetPrototypeMethod(t, "setLevel", SetLevel);
	Nan::SetPrototypeMethod(t, "setLocation", SetLocation);
	Nan::SetPrototypeMethod(t, "setName", SetName);
	Nan::SetPrototypeMethod(t, "switchOn", SwitchOn);
	Nan::SetPrototypeMethod(t, "switchOff", SwitchOff);
	Nan::SetPrototypeMethod(t, "enablePoll", EnablePoll);
	Nan::SetPrototypeMethod(t, "disablePoll", EnablePoll);
	Nan::SetPrototypeMethod(t, "hardReset", HardReset);
	Nan::SetPrototypeMethod(t, "softReset", SoftReset);
/*
